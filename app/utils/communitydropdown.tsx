    ...
    <div className="relative inline-block">
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-48 bg-white border rounded shadow-lg">
          <a href="#" className="block px-4 py-2 text-gray-800 hover:bg-gray-100">Neighbor Connect</a>
          <a href="#" className="block px-4 py-2 text-gray-800 hover:bg-gray-100">Unity Hub</a>
          <a href="#" className="block px-4 py-2 text-gray-800 hover:bg-gray-100">Society Spot</a>
        </div>
      )}
    </div>
  );
