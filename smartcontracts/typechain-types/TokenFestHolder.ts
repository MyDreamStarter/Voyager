...
export interface TokenFestHolderInterface extends utils.Interface {
  ...
  functions: {
    ...
    "refundStatus(address)": FunctionFragment;
    "safeTransferFrom(address,address,uint256)": FunctionFragment;
    "salePrice()": FunctionFragment;
    "setApprovalForAll(address,bool)": FunctionFragment;
    "setFundingEndTime(uint256)": FunctionFragment;
    "setFundingEndTimeOperator(uint256)": FunctionFragment;
    "setFundingStartTime(uint256)": FunctionFragment;
    "setFundingStartTimeOperator(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setFundingEndTimeOperator",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setFundingStartTimeOperator",
    values: [BigNumberish]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "yieldSubmission",
    values?: undefined
  ): string;
...
export type RefundClaimedEvent = TypedEvent<
  ...
  { quantity: BigNumber; owner: string; amount: BigNumber }
>;
...
export type TicketMintedEvent = TypedEvent<
  ...
  { previousSupply: BigNumber; currentSupply: BigNumber; creator: string }
>;
...
export interface TokenFestHolder extends BaseContract {
  contractName: "TokenFestHolder";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenFestHolderInterface;
  ...
  functions: {
    ...
    refundStatus(arg0: string, overrides?: CallOverrides): Promise<[boolean]>;
  ...
  filters: {
    ...
    "TicketMinted(uint256,uint256,address)"(
      previousSupply?: BigNumberish | null,
      currentSupply?: BigNumberish | null,
      creator?: string | null
  ...
  estimateGas: {
    ...
    refundStatus(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
