...
export interface TokenFestCollabInterface extends utils.Interface {
  ...
  functions: {
    ...
    "reverseRejection(bool)": FunctionFragment;
    "safeTransferFrom(address,address,uint256)": FunctionFragment;
    "salePrice()": FunctionFragment;
    "setApprovalForAll(address,bool)": FunctionFragment;
    "setData(bool,bool,bool,bool)": FunctionFragment;
    ...
    "stakeRefundByOperator()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "reverseRejection",
    values: [boolean]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "stakeRefundByOperator",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface TokenFestCollab extends BaseContract {
  contractName: "TokenFestCollab";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenFestCollabInterface;
  ...
  callStatic: {
    ...
    reverseRejection(state: boolean, overrides?: CallOverrides): Promise<void>;
    ...
    stakeRefundByOperator(overrides?: CallOverrides): Promise<BigNumber>;
